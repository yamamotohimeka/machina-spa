...
<div class="mainvisual">
    <div class="main-img-innerwrap">
        ...
        <p class="sp-credit"><a href="https://pay2.star-pay.jp/site/pc/shop.php?tel=&payc=A2038&guide="
                target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/credit.png" alt=""></a></p>
        <div class="slider">
            <?php $args= array(
        'post_type' => 'banner',
        'posts_per_page' => 5,
      ...
      ?>
            <?php while($the_query->have_posts()) : $the_query->thaaaae_post();?>
    ...
    <ul class="mainvisual-menu">
        <li class="mainvisual-menu-list"><a
            ...
            <section class="about">
                ...
                <div class="about-contentwrap">
                    ...
                    <div class="about-content">
                        <img src="<?php echo get_template_directory_uri() ?>/images/about-img1.png"
                            alt="オイルマッサージへのこだわり">
