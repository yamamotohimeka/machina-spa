...
<section class="author section-bg">
  <h2 class="page-title">セラピスト詳細</h2>
    ...
    <div class="author-wrapper">
              ...
              <div class="options-flex">
                ...
                <div class="author-twitter">
                  <a href="https://twitter.com/<?php echo $udata->twitter;?>" target="_blank">
                    <img src="<?php echo get_template_directory_uri() ?>/images/author-x.png" alt="twitter icon">
                  </a>
                </div>
                <?php endif ; ?>
      ...
      <div class="author-wrapper-right">
        ...
        $diary_args = array(
          ...
          ?>
            ...
            <div class="author-diary-inner">
              <a href="<?php the_permalink(); ?>">
                ...
                <time class="diary__time"
                  datetime="<?php echo esc_attr(get_field('diary_date_japan', get_the_ID())); ?>">
          ...
          <div class="gototherapists-wrap sp">
