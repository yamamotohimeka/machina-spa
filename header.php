                        ...
                        <div class="header-inner">
                            <div class="header-logo-wrap">
                                <h1 class="header-logo"><a href="<?php echo home_url('/'); ?>"><img
                                            src="<?php echo get_template_directory_uri() ?>/images/header-logo.png"
                                            alt="MACHINASPAロゴ画像"></a>
                                </h1>
                                <div class="header-logo-text-wrap">
                                    <p class="header-logo-text">南船場・堺筋本町</p>
                                    <p class="header-sns-lineid"><a href="https://line.me/ti/p/71Sadk-PUI"
                                            target="_blank">LINE
                            ...
                            <nav class="global-nav">
                                <ul>
                                    ...
                                    <li class="nav-li"><a
                                            href="<?php echo home_url('/ranking'); ?>">ランキング<span>RANKING</span></a>
                                    </li>
                                    <li class="nav-li"><a
                                            href="<?php echo home_url('/newface'); ?>">新人情報<span>NEWFACE</span></a></li>
                                    <li class="nav-li"><a
                                            href="<?php echo home_url('/schedule'); ?>">出勤情報<span>SCHEDULE</span></a>
                                    </li>
                                    <li class="nav-li"><a
                                            href="<?php echo home_url('/system'); ?>">システム料金<span>SYSTEM</span></a></li>
                                    <li class="nav-li"><a
                                            href="https://pay2.star-pay.jp/site/pc/shop.php?tel=&payc=A2038&guide="
                                            target="_blank">クレジットカード決済<span>CREDIT CARD</span></a></li>
                                    <li class="nav-li"><a
                                            href="<?php echo home_url('/access'); ?>">アクセス<span>ACCESS</span></a></li>
                                    <li class="nav-li"><a href="http://frogspa.livedoor.blog/"
                            ...
                            <div class="header-sns-wrap">
                                <ul class="header-sns-listwrap">
                                    <li class="header-sns-list"><a href="http://frogspa.livedoor.blog/"
                                            target="_blank"><img
                                                src="<?php echo get_template_directory_uri() ?>/images/header-blog-icon.png"
                                                alt="ブログアイコン"><span>BLOG</span></a></li>
                                    <?php if($user_twitter) : ?>
                                    <li class="header-sns-list"><a
                                            href="https://twitter.com/<?php echo $user_twitter; ?>" target="_blank"><img
                                                src="<?php echo get_template_directory_uri() ?>/images/header-twitter.png"
                                                alt="twitterアイコン"><span>X</span></a></li>
                                    <?php endif;?>
                                    <li class="header-sns-list"><a href="https://line.me/ti/p/71Sadk-PUI"
                                            target="_blank"><img
                            ...
                            <div class="header-pc-shopinfo">
                                ...
                                <p class="header-credit"><a
                                        href="https://pay2.star-pay.jp/site/pc/shop.php?tel=&payc=A2038&guide="
                                        target="_blank"><img
                                            src="<?php echo get_template_directory_uri() ?>/images/credit.png"
                                            alt=""></a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div id="global-nav" class="pc-global-navwrap">
                        <ul class="pc-header-menu">
                            <li class="pc-header-menu-list"><a
                                    href="<?php echo home_url('/'); ?>"><span>ホーム</span>HOME</a></li>
                            <li class="pc-header-menu-list"><a
                            ...
                            <li class="pc-header-menu-list"><a
                                    href="<?php echo home_url('/newface'); ?>"><span>新人情報</span>NEWFACE</a>
                            </li>
                            <li class="pc-header-menu-list"><a
                                    href="<?php echo home_url('/system'); ?>"><span>システム料金</span>SYSTEM</a>
                            </li>
                            <li class="pc-header-menu-list"><a
                                    href="https://pay2.star-pay.jp/site/pc/shop.php?tel=&payc=A2038&guide="
                                    target="_blank"><span>クレジットカード決済</span>CREDIT CARD</a></li>
                            <li class="pc-header-menu-list"><a
                                    href="<?php echo home_url('/access'); ?>"><span>アクセス</span>ACCESS</a>
                            </li>
