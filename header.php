...
<head>
  <meta charset="UTF-8">
  <title>大阪 南船場・堺筋本町のメンズエステ【frogspa】フロッグスパ</title>
  <meta name="viewport"
    content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
  <meta name="description"
    content="大阪長堀橋駅・堺筋本町駅から徒歩1分圏内にある、南船場・堺筋本町のメンズエステ【frogspa】フロッグスパ。当店は、南船場で極上のメンズエステをご提供しております。日頃のストレスを厳選されたセラピストがお客様の疲れ切った全身をアロマオイルで全身マッサージして心も身体も揉みほぐします。">
  <meta name="keywords" content="大阪,南船場,堺筋本町,メンズエステ,frogspa,フロッグスパ">
  ...
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/ fb# prefix属性: http://ogp.me/ns/website#">
    ...
    <meta property="og:title" content="大阪 南船場・堺筋本町のメンズエステ【frogspa】フロッグスパ" />
    <meta property="og:description"
      content="大阪長堀橋駅・堺筋本町駅から徒歩1分圏内にある、南船場・堺筋本町のメンズエステ【frogspa】フロッグスパ。当店は、南船場で極上のメンズエステをご提供しております。日頃のストレスを厳選されたセラピストがお客様の疲れ切った全身をアロマオイルで全身マッサージして心も身体も揉みほぐします。" />
    <meta property="og:site_name" content="大阪 南船場・堺筋本町のメンズエステ【frogspa】フロッグスパ" />
    <meta property="og:image" content="https://frog-spa.com/wp-content/themes/frogspa/images/frog-ogp.png" />
    <!-- /////////////////ogp -->
        ...
        <header class="header" id="header">
            ...
            <div class="header-inner">
              <div class="header-logo-wrap">
                <h1 class="header-logo"><a href="<?php echo home_url('/'); ?>"><img
                      src="<?php echo get_template_directory_uri() ?>/images/header-logo.png" alt="FROG SPAロゴ画像"></a>
                </h1>
              ...
              <nav class="global-nav">
                <ul>
                  <li class="nav-li"><a href="<?php echo home_url('/'); ?>">ホーム<span>HOME</span></a></li>
                  <li class="nav-li"><a href="<?php echo home_url('/therapists'); ?>">セラピスト一覧<span>THERPIST</span></a>
                  </li>
                  <li class="nav-li"><a href="<?php echo home_url('/ranking'); ?>">ランキング<span>RANKING</span></a></li>
                  <li class="nav-li"><a href="<?php echo home_url('/newface'); ?>">新人情報<span>NEWFACE</span></a></li>
                  <li class="nav-li"><a href="<?php echo home_url('/schedule'); ?>">出勤情報<span>SCHEDULE</span></a></li>
                  ...
                  <li class="nav-li"><a href="https://recruit-frogspa.com/" target="_blank">求人情報<span>RECRUIT</span></a>
                  </li>
                </ul>
              </nav>
                ...
                <ul class="header-sns-listwrap">
                  ...
                  <li class="header-sns-list"><a href="https://twitter.com/<?php echo $user_twitter; ?>"
                      target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/header-twitter.png"
                        alt="twitterアイコン"><span>Twitter</span></a></li>
                  <?php endif;?>
              ...
              <div class="header-pc-shopinfo">
                <p class="header-pc-shopinfo-time">営業時間 11:00〜27:00（受付時間 10:00〜25:30）</p>
          ...
          <div id="global-nav" class="pc-global-navwrap">
            <ul class="pc-header-menu">
              ...
              <li class="pc-header-menu-list"><a href="https://recruit-frogspa.com/"
