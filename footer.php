...
<footer class="footer">
  <div class="footer-flexdiv">
    <ul class="footer-spnav">
      ...
      <li class="footer-spnav-list"><a href="<?php echo home_url('/ranking'); ?>">ランキング<span>RANKING</span></a></li>
      <li class="footer-spnav-list"><a href="<?php echo home_url('/newface'); ?>">新人情報<span>NEWFACE</span></a></li>
      ...
      <li class="footer-spnav-list"><a href="<?php echo home_url('/recruit'); ?> ">求人情報<span>RECRUIT</span></a></li>
      ...
      <li class="footer-spnav-list"><a href="https://twitter.com/<?php echo $user_twitter; ?>"
          target="_blank">ツイッター<span>TWITTER</span></a></li>
      <?php endif; ?>
    </ul>
    <div class="footer-logo-wrap">
      <h2 class="footer-logo">
        <img src="<?php echo get_template_directory_uri() ?>/images/header-logo.png" alt="FROG SPAロゴ画像">
      ...
      <p class="gotop"><a href="#header"><img src="<?php echo get_template_directory_uri() ?>/images/gotop.png"
            alt="矢印"></a></p>
      <p class="footer-logo-hours">営業時間 11:00〜27:00（受付時間 10:00〜25:30）</p>
    ...
    <div class="footer-pc-navwrap">
      ...
      <div class="footer-nav-imgwrap">
        ...
        <p class="footer-nav-img"><a href="https://osaka.refle.info/" target="_blank"><img
              src="<?php echo get_template_directory_uri() ?>/images/footer-banner1.gif" alt="リフナビ大阪"></a></p>
        ...
        <p class="footer-nav-img"><a href="https://choi-es.com/" target="_blank"><img
              src="https://choi-es.com/banner/200_40.png" alt="メンズエステ店を投票ランキングで検索｜Choi-Es（チョイエス）大阪"></a></p>
