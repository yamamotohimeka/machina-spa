...
<footer class="footer">
    <div class="footer-flexdiv">
        <ul class="footer-spnav">
            ...
            <li class="footer-spnav-list"><a
                    href="<?php echo home_url('/therapists'); ?>">セラピスト一覧<span>THERPIST</span></a>
            </li>
            ...
            <li class="footer-spnav-list"><a href="http://frogspa.livedoor.blog/"
                    target="_blank">ブログ<span>BLOG</span></a>
            </li>
            <?php if ($user_twitter) : ?>
        ...
        <div class="footer-logo-wrap">
            ...
            <ul class="footer-logo-snswrap">
                ...
                <?php if ($user_twitter) : ?>
                <li class="footer-logo-snslist"><a href="https://twitter.com/<?php echo $user_twitter; ?>"
        ...
        <div class="footer-pc-navwrap">
            <ul class="footer-pc-nav">
                ...
                <li class="footer-pc-nav-list"><a
                        href="https://pay2.star-pay.jp/site/pc/shop.php?tel=&payc=A2038&guide="
            ...
            <div class="footer-nav-imgwrap">
                ...
                <p class="footer-nav-img" style="text-align: center;"><a href="https://es-ban.com/p/5285/"
                        target="_blank"><img src="https://es-ban.com/lp/banner/300-60.jpg" width="300" height="60"
                            border="0" alt="大阪府のメンズエステ情報ならエステ番長"></a></p>
                ...
                <p class="footer-nav-img" style="margin-right:200px">
                    <a href="https://h55.jp/"><img src="https://h55.jp/img2/h55_30060.jpg"
                            alt="エスワク｜メンズエステの求人クチコミ検索"></a>
                </p>
                ...
                <p class="footer-nav-img"><a href="https://osaka.aroma-tsushin.com/" target="_blank"><img
                            src="<?php echo get_template_directory_uri() ?>/images/footer-img2.jpg"
                            alt="優良エステ店　アロマパンダ通信推奨"></a></p>
                <p class="footer-nav-img"><a href="https://panda-job.com/" target="_blank"><img
                            src="<?php echo get_template_directory_uri() ?>/images/footer-banner03.jpg"
                            alt="女性の安心求人情報パンダエステジョブ"></a>
                </p>
                ...
                <p class="footer-nav-img"><a href="https://esthe-zukan.com/" target="_blank"><img
                            src="https://esthe-zukan.com/lib/img/banner200x40.png"
                            alt="メンズエステで使えるクーポンサイト「エステ図鑑 全国版」 /"></a></p>
                ...
                <p class="footer-nav-img"><a href="https://ore-aroma.jp/" target="_blank"><img
                            ...
                            style="width:200px;height:40px"></a></p>
                <p class="footer-nav-img"><a href="https://h55.jp/" target="_blank"><img
                            src="https://h55.jp/img2/h55_20040.jpg" alt="エスワク｜メンズエステの求人クチコミ検索" target="_blank"
                            style="width:200px;height:40px"></a></p>
                ...
                <p class="footer-nav-img"><a href="https://menesjapon-job.com/" target="_blank"><img
                            src="https://menesjapon-job.com/assets/img/banner200.gif" alt="メンズエステ求人「メンエスジャポン求人」"
                            target="_blank" style="width:200px;height:40px" /></a></p>
                <p class="footer-nav-img">
                    <a href="https://me-navi.com/job/" target="_blank"><img
                            src="https://me-navi.com/asset/img/j_200_40.gif" alt="メンズエステバイト情報【メンエスナビ求人】" target="_blank"
                ...
                <p class="footer-nav-img"><a href="https://esthe-r.com/?m=shop/index&region=5&pref=27&area=84"
                        target="_blank"><img src="https://esthe-r.com/images/user/bnr_200x040.jpg"
                            alt="大阪府長堀橋・心斎橋・南船場のメンズエステ求人・高収入アルバイト「メンエスリクルート」" target="_blank"
                            style="width:200px;height:40px" /></a>
                </p>
                <p class="footer-nav-img">
                ...
                <p class="footer-nav-img"><a href="https://menesthe.net/" target="_blank" rel="noopener"><img
                            ...
                            src="https://menesthe.net/wp-content/uploads/2021/12/Web-1920-–-5-1.png" alt="近くのメンズエステおすすめ"
                ...
                <p style="text-align:center; padding-bottom:3px; margin:0;"><a
                        href="https://ranking-mensesthe.jp/article6874/" target="_blank"><img
                ...
                <p class="footer-nav-img">
                    <a href="https://menes-ikitai.co.jp/" target="_blank"> <img
                            src="https://menes-ikitai.co.jp/wp-content/uploads/2022/10/メンエスイキタイ-200-×-40-px.png"
                            width="200" height="40" border="0" alt="メンエスイキタイ"> </a>
                </p>
                <p class="footer-nav-img">
                    <a href="https://menes-ikitai.co.jp/osaka/sakaisuji-honmachi-ranking/" target="_blank"> <img
                            src="https://menes-ikitai.co.jp/wp-content/uploads/2023/03/4-2.png" width="200" height="40"
                            border="0" alt="【厳選】堺筋本町メンズエステ_メンエスイキタイ"> </a>
                </p>
                ...
                <p class="footer-nav-img">
                    <a href="https://me-navi.com" rel="nofollow noopener" target="_blank"><img
                            src="https://me-navi.com/asset/img/200_40.gif"
                            alt="男性向けリラクゼーションサロン専門情報サイト そけい部長のメンエスナビ"></a>
                </p>
